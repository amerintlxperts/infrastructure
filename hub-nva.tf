resource "azurerm_network_interface" "hub-nva-external_network_interface" {
  ...
  accelerated_networking_enabled = var.PRODUCTION_ENVIRONMENT ? true : false
...
resource "azurerm_linux_virtual_machine" "hub-nva_virtual_machine" {
  ...
  network_interface_ids           = [azurerm_network_interface.hub-nva-external_network_interface.id]
